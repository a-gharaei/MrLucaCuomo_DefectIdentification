...
startpoint_difference = [0, 2.3264705882, 13.9890710383] # difference to the startpoint of the laser in mm
endpoint_difference = [20, 23.8235294118, 28.1318681319] # difference in length from one rotation

########################################################################################################################
# Get data
########################################################################################################################
LaserDataRaw = 'LaserDataRaw/LC_001_2022-03-30 17.25.59.602_A0000.csv'
df_Laser = pd.read_csv(LaserDataRaw)

folder_time_stamp = 'C:/Users/cuomo_g6z0s1c/PycharmProjects/BachelorThesis/Time_stamps_picture'
...
folder = 'C:/Users/cuomo_g6z0s1c/PycharmProjects/BachelorThesis/LaserWindow/'
file = ['LaserWindow20mm.csv', 'LaserWindow30mm.csv', 'LaserWindow40mm.csv']

new_df.to_csv(folder+file[case])
