...
TimeStepLaser = int(TimeStepLaser*10**5) # to get integer
TimeStepCamera = int(TimeStepCamera*10**5) #to get integer
...
#print(df_Laser.iloc[start_index])
...
#ind = dataLaser[dataLaser['time_index']==0].index
#ind = ind[0]

for i in range(pictureNumber):
    ind = dataLaser[dataLaser['time_index'] == i*TimeStepCamera].index
    ind = ind[0]
